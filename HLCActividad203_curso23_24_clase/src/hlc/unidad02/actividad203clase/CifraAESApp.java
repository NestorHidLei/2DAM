...
public class CifraAESApp {
  ...
  public static void main(String[] args) {
    ...
    try {
      mensajeCifrado = cifraMensaje(parametros.getMensaje(), parametros.getPassword());
  ...
  private static String cifraMensaje(String mensaje, String password) throws NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException  {
