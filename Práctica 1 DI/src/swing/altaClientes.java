...
public class altaClientes extends JFrame {
    ...
    public altaClientes(swingApp frame) {
        ...
        lblNuevoCliente.setBounds(187, 5, 182, 37);
        ...
        String[] provincias = {
            "Málaga", "Sevilla", "Almería", "Huelva", "Granada",
            "Jaén", "Córdoba", "Cádiz"
        };
        ...
        btnAniadirCliente.setBounds(221, 164, 114, 47);
    ...
    protected void añadirCliente() {
        ...
        mainFrame.updateListModel(); // Actualizar el modelo en la ventana principal
        dispose(); // Cerrar la ventana de alta clientes
    }
}